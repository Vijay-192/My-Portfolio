    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          ...
          className="edu-btn-primary flex items-center gap-2 px-5 py-3 rounded-lg"
        >
      ...
      {loading ? (
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4 flex items-center gap-3">
            ...
            <Zap className="w-5 h-5" style={{ color: "var(--edu-primary)" }} />
            All Skills
                        ...
                        <div className="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-2">
                          <div
                            ...
                            style={{
                              ...
                              background: item.color || "var(--edu-primary)",
                            }}
                          />
                        </div>
                      </td>
          ...
          <div className="edu-modal-wrap bg-white dark:bg-gray-800 rounded-2xl w-full max-w-lg shadow-2xl max-h-[92vh] overflow-y-auto">
            ...
            <div className="edu-modal-header border-b border-gray-200 dark:border-gray-700 p-6 flex justify-between items-center sticky top-0 bg-white dark:bg-gray-800 z-10">
              <div className="flex items-center gap-3">
                <div className="edu-accent-bar" />
                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Add Skill</h2>
              </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    {PRESET_COLORS.map(({ label, color }) => (
                      <button
                        ...
                        title={label}
                        className={`w-7 h-7 rounded-lg border-2 transition-all hover:scale-110 ${form.color === color
                  ...
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      <input
                        ...
                        className="w-12 h-10 rounded-lg cursor-pointer border border-gray-200 dark:border-gray-700 p-0.5 bg-transparent"
                      />
                    </div>
                    <input
                      name="color"
                    ...
                    {/* Live preview */}
                    <div
                      className="w-10 h-10 rounded-lg flex-shrink-0 border border-gray-200 dark:border-gray-700"
                      ...
                      {imagePreview ? (
                        <div className="flex items-center justify-center h-28 p-4">
                          <img src={imagePreview}
                            className="h-full object-contain rounded" alt="preview" />
                        </div>
                      ) : (
            ...
            <div className="edu-modal-footer border-t border-gray-200 dark:border-gray-700 p-4">
              <button
                type="button"
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-md shadow-2xl p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100">Delete Skill?</h3>
