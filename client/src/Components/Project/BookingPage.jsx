...
//   .bp-scroll::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.08); border-radius: 99px; }
...
// `;
// function injectCSS() {
//   if (document.getElementById("bpg-styles")) return;
...
//               <div>
//                 <div style={{ fontSize: 13, fontWeight: 600, color: active ? "#eeeef2" : "rgba(255,255,255,0.45)", lineHeight: 1.3 }}>
//                   {s.label}
//                 </div>
//                 <div style={{ fontSize: 11, color: active ? "rgba(255,255,255,0.38)" : "rgba(255,255,255,0.18)", marginTop: 2 }}>
//                   {s.sub}
//                 </div>
//               </div>
//             </div>
...
//             {i < steps.length - 1 && (
//               <div style={{ width: 1, height: 12, background: "rgba(255,255,255,0.06)", margin: "0 0 0 25px" }} />
//             )}
//           </React.Fragment>
//         );
//       })}
...
//             borderRadius: 8, width: 32, height: 32, cursor: isPrevDis ? "not-allowed" : "pointer",
//             color: "rgba(255,255,255,0.4)", opacity: isPrevDis ? 0.22 : 1,
//             display: "flex", alignItems: "center", justifyContent: "center",
//             fontSize: 40, transition: "all 0.15s", fontFamily: "inherit",
//           }}>‹</button>

//         <span style={{ fontSize: 14, fontWeight: 600, letterSpacing: "0.03em", color: "#eeeef2" }}>
...
//                 fontWeight: isSel ? 700 : 400, cursor: dis ? "default" : "pointer",
//                 transition: "all 0.13s",
//                 fontFamily: "var(--mono, 'DM Mono', monospace)",
//                 color: dis ? "rgba(255,255,255,0.13)"
//                   : isSel ? "#fff" : isTod ? "#ff8935" : "#c2c2c2",
//                 background: isSel ? "linear-gradient(135deg,#ff8935,#ff6a00)" : "transparent",
//                 border: `1px solid ${isSel ? "transparent" : isTod && !isSel ? "rgba(255,106,0,0.35)" : "transparent"}`,
...
//             <div key={i} style={{
//               height: 40, borderRadius: 8, background: "rgba(255,255,255,0.04)",
...
//                 border: `1px solid ${isBooked ? "rgba(255,255,255,0.05)" : isSel ? "rgba(255,106,0,0.6)" : "rgba(255,255,255,0.09)"}`,
//                 background: isBooked ? "rgba(255,255,255,0.02)" : isSel ? "rgba(255,106,0,0.12)" : "rgba(255,255,255,0.03)",
//                 color: isBooked ? "rgba(255,255,255,0.15)" : isSel ? "#ff8935" : "#a8a8c0",
//               }}>
//               {slot}
//               {isBooked && (
//                 <div style={{ fontSize: 9, color: "rgba(255,255,255,0.18)", marginTop: 3, letterSpacing: "0.04em" }}>
//                   Booked
//                 </div>
//               )}
//             </div>
...
//       <span style={{ color: "rgba(255,255,255,0.3)", display: "flex", alignItems: "center" }}>{icon}</span>
...
//             <span style={{ fontSize: 13, fontWeight: accent ? 600 : 400, color: accent ? "#ff8935" : "#d0d0e0", flex: 1, wordBreak: "break-all" }}>
//               {value}
//             </span>
//           </div>
//         ))}
...
//         }}>
//           <div style={{ fontSize: 11, fontWeight: 600, color: "rgba(255,255,255,0.28)", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 }}>
//             Note
//           </div>
...
//         borderRadius: 12, padding: "12px 16px",
//       }}>
//         <span style={{ color: "rgba(255,255,255,0.3)", display: "flex", marginTop: 1 }}><I.Mail /></span>
...
//     justifyContent: "center", flex: 1, gap: 22, textAlign: "center", padding: "24px 0",
//   }}>
//     <div className="bp-pop" style={{
//       width: 70, height: 70, borderRadius: "50%",
//       background: "rgba(255,106,0,0.08)", border: "1.5px solid rgba(255,106,0,0.28)",
//       display: "flex", alignItems: "center", justifyContent: "center",
//     }}>
//       <I.BigCheck />
//     </div>
...
//         borderRadius: 7, padding: "3px 14px", fontSize: 11, color: "#ff8935",
...
//       borderRadius: 14, padding: "16px 28px", fontSize: 13, color: "rgba(255,255,255,0.42)",
...
//             borderRadius: 10, padding: "7px 15px", color: "rgba(255,255,255,0.45)",
...
//                   : i < step ? "rgba(255,106,0,0.4)" : "rgba(255,255,255,0.1)",
//                 transition: "all 0.3s",
//               }} />
//             ))}
...
//         {/* ── Sidebar ── */}
//         <div style={{
//           width: 252, minWidth: 252, borderRight: "1px solid rgba(255,255,255,0.06)",
...
//             ].map(({ icon, text }) => (
//               <div key={text} style={{ display: "flex", alignItems: "center", gap: 10, fontSize: 12, color: "rgba(255,255,255,0.32)" }}>
...
//                 <h1 style={{ fontSize: 20, fontWeight: 700, color: "#eeeef2", marginBottom: 4, letterSpacing: "-0.01em" }}>
...
//                     <SectionLabel icon={<I.Cal />} title="Select a Date" badge="Sundays unavailable" />
...
//                     borderRadius: 10, fontSize: 12, color: "#f87171", textAlign: "center",
//                   }}>
//                     {submitError}
//                   </div>
//                 )}
...
//                       background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.09)",
//                       borderRadius: 10, padding: "9px 18px", color: "rgba(255,255,255,0.4)",
//                       fontSize: 12, fontWeight: 500, cursor: "pointer",
//                       transition: "all 0.18s", fontFamily: "inherit",
//                     }}>
//                     <I.Back />
...
//                     style={{
//                       display: "inline-flex", alignItems: "center", gap: 8,
//                       background: ctaDisabled ? "rgba(255,106,0,0.12)" : "linear-gradient(135deg,#ff8935,#ff6a00)",
//                       border: "none", borderRadius: 10, padding: "10px 22px",
//                       color: ctaDisabled ? "rgba(255,255,255,0.22)" : "#fff",
//                       fontSize: 13, fontWeight: 600, cursor: ctaDisabled ? "not-allowed" : "pointer",
//                       fontFamily: "inherit",
...
//                     style={{
//                       display: "inline-flex", alignItems: "center", gap: 8,
//                       background: submitting ? "rgba(255,106,0,0.12)" : "linear-gradient(135deg,#ff8935,#ff6a00)",
//                       border: "none", borderRadius: 10, padding: "10px 22px",
...
// ─────────────────────────────────────────────
// SCOPED CSS  (injected with unique ID, removed on unmount)
// ─────────────────────────────────────────────
